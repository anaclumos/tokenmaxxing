...
async function seed() {
  ...
  saveConfig({ thresholds: { session: 95, weekly: 95 }, claudeBin: "/usr/bin/true", policy: { projectionMargin: 0, greedySessionFloor: 50, switchModels: ["fable", "opus"], usagePollTtlMs: 90_000, maxWaitMs: 3_600_000 } });
