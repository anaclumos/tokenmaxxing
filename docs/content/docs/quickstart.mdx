...
Requires [Bun](https://bun.sh) and Claude Code, on macOS or Linux. Install with Bun, or from the flake if you already use Nix / nix-darwin (see [Build and distribution](/distribution)):
