...
`TOKENMAXXING_SKIP_TIMER=1` makes `init` skip the timer unit on both platforms; the Nix modules export it when they own the timer (see [Build and distribution](/distribution)).
