...
const zh: Partial<Translations> = {
  ...
  "Prop(type table)": '属性',
  "Read {url}, I want to ask questions about it.(page actions)": '阅读 {url}，我想就此提问。',
  ...
  "The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.(404 not found page)": '您查找的页面可能已被移除、更名或暂时无法访问。',
