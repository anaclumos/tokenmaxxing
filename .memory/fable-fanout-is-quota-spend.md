...
**Why:** Fable-tier fan-out here is not free compute, it is metered spend against the owner's live accounts, the same class as `status --force` under [[live-pool-runs-need-permission]].
