...
- [ ] Ship: CI green on #57 after the last push, 10-minute window from the last push, handle any further reviews, merge, `gh release create v1.10.0`, `npm view tokenmaxxing version` shows 1.10.0, teardown
