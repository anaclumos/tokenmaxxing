...
- Wrote an em-dash in a ci.yml comment and in package.json's description. The em-dash ban covers every file (comments, YAML, JSON strings), not just prose; grep changes for `—` before finishing.
