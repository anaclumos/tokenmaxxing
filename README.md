...
| `tokenmaxxing doctor` | verify the install: PATH order, `claudeBin`, the five settings entries, the timer, every Claude and Codex store's credential identity, codex hook trust, setup-token age, and shell aliases that shadow `claude` |
